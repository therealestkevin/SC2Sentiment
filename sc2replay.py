...
allRecordings = [f for f in listdir('H:/3.16.1-Pack_1-fix/Replays') if isfile(join('H:/3.16.1-Pack_1-fix/Replays', f))]

for curFile in allRecordings:
    archive = mpyq.MPQArchive('H:/3.16.1-Pack_1-fix/Replays/' + curFile)
